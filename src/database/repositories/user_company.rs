...
impl UserCompanyRepository {
    ...
    pub async fn create_balance(&self, request: &CreateUserCompanyRequest) -> Result<UserCompany> {
    ...
    pub async fn update_balance(
        ...
        user_id: &str,
        company_id: i64,
        request: &UpdateUserCompanyRequest,
    ) -> Result<UserCompany> {
    ...
    pub async fn create_or_update_balance(
        ...
        user_id: &str,
        company_id: i64,
        request: &CreateUserCompanyRequest,
    ) -> Result<UserCompany> {
        ...
        {
            // Update existing
            let update_request = UpdateUserCompanyRequest {
