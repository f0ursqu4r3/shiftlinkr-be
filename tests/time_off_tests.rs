...
async fn setup_test_app() -> (web::Data<AppState>, web::Data<TimeOffRepository>, web::Data<be::Config>) {
...
test_unauthorized!(test_create_time_off_request_unauthorized, post, "/api/v1/time-off", json!({
    "user_id": "test_user",
...
test_unauthorized!(test_get_time_off_requests_unauthorized, get, "/api/v1/time-off");
test_unauthorized!(test_get_time_off_request_unauthorized, get, "/api/v1/time-off/123");
test_unauthorized!(test_update_time_off_request_unauthorized, put, "/api/v1/time-off/123", json!({
    "user_id": "test_user",
    "start_date": "2024-01-01",
    "end_date": "2024-01-05",
...
test_unauthorized!(test_delete_time_off_request_unauthorized, delete, "/api/v1/time-off/123");

// Time off request approval tests
test_unauthorized!(test_approve_time_off_request_unauthorized, post, "/api/v1/time-off/123/approve", json!({
    "notes": "Approved for vacation"
}));
test_unauthorized!(test_deny_time_off_request_unauthorized, post, "/api/v1/time-off/123/deny", json!({
