...
async fn setup_test_app() -> (web::Data<AppState>, web::Data<ShiftRepository>, web::Data<be::Config>) {
...
// Shift CRUD tests
test_unauthorized!(test_create_shift_unauthorized, post, "/api/v1/shifts", json!({
    "location_id": 1,
    "team_id": 1,
...
test_unauthorized!(test_update_shift_unauthorized, put, "/api/v1/shifts/1", json!({
    "location_id": 1,
    "team_id": 1,
    "start_time": "2024-01-01T10:00:00Z",
...
test_unauthorized!(test_assign_shift_unauthorized, post, "/api/v1/shifts/1/assign", json!({
    "user_id": "user123"
}));
test_unauthorized!(test_unassign_shift_unauthorized, post, "/api/v1/shifts/1/unassign", json!({
    "user_id": "user123"
}));

// Shift status tests
test_unauthorized!(test_update_shift_status_unauthorized, put, "/api/v1/shifts/1/status", json!({
    "status": "completed"
}));

// Shift claim tests
test_unauthorized!(test_claim_shift_unauthorized, post, "/api/v1/shifts/1/claim", json!({}));
